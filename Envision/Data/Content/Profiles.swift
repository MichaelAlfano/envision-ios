...
extension Content {
    static let profiles: [ProfileData] = [
        ProfileData(
            ...
            whyPhysics: "Since I was in middle school I have loved math, science, and technology and after taking physics my freshmen year I fell in love with it. The subject satisfied all of the characteristics I was looking for in a career which lead me to get a physics minor in addition to a major in computer science. In my physics education, I developed the skills and knowledge base that I needed in my future career. Through years of studying and honing my skills along with many internships and other jobs I have finally ended up with my dream job at NASA.",
            usingPhysics: "Having a minor in physics has allowed me to be a better team member in organizations such as the NSA, NASA, and Tesla. Through my minor I not only learned the critical theories of physics, but I also developed my problem solving skills which are extremely useful in the field of software engineering. In my time in the field of computer science I have contributed to Tesla FSD Beta 9.5 through the official release of FSD to all Tesla owners with the FSD package. I have also contributed at the NSA where I worked to protect the cybersecurity of US pipelines, including the Colonial Pipeline, in addition to working on various homeland security projects.",
        ...
        ProfileData(
            ...
            usingPhysics: "I’ve been working on finding what does the brain, neurons and nerve signals have to do with cancer causes while I am sure that every single organ in the living body is being controlled by some nerve signals coming out from the brain.",
...
/*
 What you would look like as a physicist?
 */
